...
query="get key1\r\n"
printf "$query" | nc 127.0.0.1 11311 | grep "VALUE\|END" > get1.tmp

cat get1.tmp
value_lines=$(cat get1.tmp | grep $body_size | wc -l | awk '{print $1}')
...
end_line=$(cat get1.tmp | tail -n1 |  tr -d '\r\n')
