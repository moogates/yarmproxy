...
cat mset_pipeline_6.data.tmp | nc 127.0.0.1 11311 > mset_pipeline_6.tmp
#cat x | nc 127.0.0.1 6379

expected=$(cat mset_pipeline_6.data.tmp | grep "^*" | wc -l | awk '{print $1}')
