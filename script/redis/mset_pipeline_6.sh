#gunzip -c ./mset4.data.gz ./mset5.data.gz ./mset5.data.gz ./mset10.data.gz ./mset6.data.gz ./mset4.data.gz ./mset10.data.gz ./mset7.data.gz ./mset10.data.gz ./mset8.data.gz ./mset10.data.gz ./mset4.data.gz ./mset9.data.gz ./mset10.data.gz ./mset11.data.gz ./mset12.data.gz ./mset12.data.gz ./mset14.data.gz ./mset15.data.gz > mset_pipeline_5.data.tmp
...
cat x | nc 127.0.0.1 11311 > mset_pipeline_6.tmp
#cat x | nc 127.0.0.1 6379

expected=19
res=$(cat mset_pipeline_6.tmp | wc -l | awk '{print $1}')
